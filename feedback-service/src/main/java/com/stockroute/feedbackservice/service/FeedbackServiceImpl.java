...
public class FeedbackServiceImpl implements FeedbackService {
    ...
    public void updateFeedback(Feedbackdetails updatedfeedbackdetails) throws InvalidArgumentException {
        ...
        if (feedbackdetails1.isPresent()) {
            ...
            feedbackdetails1.get().setDesignerEmail(updatedfeedbackdetails.getDesignerEmail());
    ...
    public Feedbackdetails getFeedback(String feedbackId) throws InvalidArgumentException {
        Optional<Feedbackdetails> feedbackdetails = dao.findById(feedbackId);
        return feedbackdetails.orElseThrow(() -> new InvalidArgumentException("Invalid FeedbackId"));
    }
    @Override
    public List<Feedbackdetails> getFeedbackByEmailId(String designerEmail) throws InvalidArgumentException {
        Optional<List<Feedbackdetails>> feedbackdetails = dao.findByDesignerEmail(designerEmail);
        return feedbackdetails.orElseThrow(() -> new InvalidArgumentException("Invalid FeedbackId"));
    }
}